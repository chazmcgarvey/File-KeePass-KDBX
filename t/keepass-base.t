...
# This test was changed to test that the new entry is a superhash because File::KeePassX fills in more fields
# with default values. This detail is probably too insignificant to care about.
TODO: {
    local $TODO = 'trivial File::KeePassX difference';
